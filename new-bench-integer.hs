...
main = do
    ...
    new2SmallList <- mkSmallIntegerList 1000 (\x -> N3.smallInteger (unboxInt x))
    new3SmallList <- mkSmallIntegerList 1000 (\x -> N4.smallInteger (unboxInt x))
    ...
    let gmpLargeList = map (\(b, l) -> G.mkInteger b l) largeList
        ...
        new2LargeList = map (\(b, l) -> N3.mkInteger b l) largeList
        new3LargeList = map (\(b, l) -> N4.mkInteger b l) largeList
    ...
    let gmpHugeList = map (\(b, l) -> G.mkInteger b l) hugeList
        ...
        new2HugeList = map (\(b, l) -> N3.mkInteger b l) hugeList
        new3HugeList = map (\(b, l) -> N4.mkInteger b l) hugeList

    hugeList2 <- mkLargeIntegerList 10 (200, 250)
    let gmpHugeList2 = map (\(b, l) -> G.mkInteger b l) hugeList2
        new1HugeList2 = map (\(b, l) -> N1.mkInteger b l) hugeList2
        new2HugeList2 = map (\(b, l) -> N3.mkInteger b l) hugeList2
        new3HugeList2 = map (\(b, l) -> N4.mkInteger b l) hugeList2
    ...
    let (gmpSmallPosList, smpSmallPosList, new1SmallPosList, new2SmallPosList, new3SmallPosList) =
                ...
                , map N3.absInteger new2SmallList
                , map N4.absInteger new3SmallList
                )
    ...
    let (gmpLargePosList, smpLargePosList, new1LargePosList, new2LargePosList, new3LargePosList) =
                ...
                , map N3.absInteger new2LargeList
                , map N4.absInteger new3LargeList
                )
    let (gmpFirstTen, smpFirstTen, new1FirstTen, new2FirstTen, new3FirstTen) =
                ...
                , map (\x -> N4.smallInteger (unboxInt x)) [1..10]
                )
    let (gmpFirstHundred, smpFirstHundred, new1FirstHundred, new2FirstHundred, new3FirstHundred) =
                ...
                , map (\x -> N4.smallInteger (unboxInt x)) [1..100]
                )
