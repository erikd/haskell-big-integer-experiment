...
integerToInt (Negative (NatS (W# x))) = word2Int# x
...
divModInteger _ (SmallPos 0) = error ("New4/GHC/Integer/Type.hs: line " ++ show (__LINE__ :: Int) ++ " divide by zero")
...
quotRemInteger _ (SmallPos 0) = error ("New4/GHC/Integer/Type.hs: line " ++ show (__LINE__ :: Int) ++ " divide by zero")
...
quotRemInteger _ _ = error ("New4/GHC/Integer/Type.hs: line " ++ show (__LINE__ :: Int))
