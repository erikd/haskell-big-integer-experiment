...
{-# INLINE timesNat4x2 #-}
timesNat4x2 :: WordArray -> WordArray -> Natural
timesNat4x2 !xarr !yarr =
    runStrictPrim $ do
        marr <- newWordArray 6
        x0 <- indexWordArrayM xarr 0
        y0 <- indexWordArrayM yarr 0
...
{-# INLINE timesNat4x3 #-}
timesNat4x3 :: WordArray -> WordArray -> Natural
timesNat4x3 !xarr !yarr =
    runStrictPrim $ do
        marr <- newWordArray 7
        x0 <- indexWordArrayM xarr 0
        y0 <- indexWordArrayM yarr 0
...
{-# INLINE timesNat4x4 #-}
timesNat4x4 :: WordArray -> WordArray -> Natural
timesNat4x4 !xarr !yarr =
    runStrictPrim $ do
        marr <- newWordArray 8
        x0 <- indexWordArrayM xarr 0
        y0 <- indexWordArrayM yarr 0
